		...
		<div className="ct-first-steps">
			...
			<ul>
				...
				<li>
					...
					<h4>{__(`Sidebar Options`)}</h4>

					<p>
						{__(
							`Set the sidebar width, design type, spacing, colors and more.`
						)}
					</p>
