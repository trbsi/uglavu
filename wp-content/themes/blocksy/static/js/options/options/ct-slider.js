    ...
    return (
      <div className="ct-option-slider">
        ...
        <div
          ...
          <input
            type="number"
            {...(this.props.option.ref ? { ref: this.props.option.ref } : {})}
            ...
            onChange={({ target: { value } }) =>
              this.props.onChange(
                `${value || this.getMin()}${this.getCurrentUnit()}`
              )
            }
          />
            ...
            <Fragment>
              ...
              <OutsideClickHandler
                ...
                <ul className="ct-units-list">
                  {this.props.option.units
                    .filter(({ unit }) => unit !== this.getCurrentUnit())

                    .reduce(
                      (current, el, index) => [
                        ...current.slice(0, index % 2 === 0 ? undefined : -1),
                        ...(index % 2 === 0
                          ? [[el]]
                            ...
                            onClick={() => {
                              this.props.onChange(
                                `${round(
                                  ...
                                  this.getAllowedDecimalPlaces(unit)
                                )}${unit}`
                              )
                              this.setState({
                                is_open: false
