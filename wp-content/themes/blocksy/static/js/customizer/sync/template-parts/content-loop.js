...
const renderEntries = prefix => {
  ...
  ;[...document.querySelectorAll('.entries > article')].map(singleArticle => {
    ...
    const featuredImageComponent = to.find(({ id }) => id === 'featured_image')
    ...
    to.map(component => {
      ...
      if (component.id === 'excerpt') {
        if (e.querySelector('.entry-excerpt')) {
          let newExcerpt = e
            ...
            .replace(
              new RegExp(
                `(([^\\s]+\\s\\s*){${component.excerpt_length || 40}})(.*)`
              ),
              '$1'
            )

          e.querySelector('.entry-excerpt').innerHTML = `${newExcerpt.trim()}${
            newExcerpt.trim().length ===
            e.querySelector('.entry-excerpt').innerHTML.trim().length
              ? ''
              : '…'
          }`
        }
      ...
      if (component.id === 'post_meta') {
        ...
        if ((component.meta_type || 'simple') === 'simple') {
          ;[...e.querySelectorAll('.entry-meta .ct-meta-icon')].map(el =>
            el.parentNode.removeChild(el)
          )
        } else {
          ;[...e.querySelectorAll('.entry-meta .ct-meta-label')].map(el =>
            el.parentNode.removeChild(el)
          )
        }
        ...
        if (component.meta && !component.meta.author) {
          e.querySelector('.entry-meta .ct-meta-author') &&
            e
              ...
              .removeChild(e.querySelector('.entry-meta .ct-meta-author'))
        }
        ...
        if (
          ...
          const img = e.querySelector('.entry-meta .avatar-container img')
        ...
        if (component.meta && !component.meta.date) {
          e.querySelector('.entry-meta .ct-meta-date') &&
            e
              .querySelector('.entry-meta ul')
              .removeChild(e.querySelector('.entry-meta .ct-meta-date'))
        } else {
          e.querySelector(
            ...
            moment(
              e.querySelector('.entry-meta .ct-meta-date .ct-meta-element')
                .dataset.date
            )
          )
        }
        ...
        if (component.meta && !component.meta.categories) {
          e.querySelector('.entry-meta .ct-meta-categories') &&
            e
              .querySelector('.entry-meta ul')
              .removeChild(e.querySelector('.entry-meta .ct-meta-categories'))
        } else {
          if (e.querySelector('.entry-meta .ct-meta-categories')) {
            e.querySelector('.entry-meta .ct-meta-categories').dataset.type =
        ...
        if (component.meta && !component.meta.comments) {
          e.querySelector('.entry-meta .ct-meta-comments') &&
            e
              .querySelector('.entry-meta ul')
              .removeChild(e.querySelector('.entry-meta .ct-meta-comments'))
        } else {
          if (e.querySelector('.entry-meta .ct-meta-comments')) {
            if ((component.meta_type || 'simple') === 'icons') {
              e.querySelector(
                ...
                .querySelector('.entry-meta .ct-meta-comments .ct-meta-element')
      ...
      if (component.id === 'title') {
        const newHeading = document.createElement(component.heading_tag || 'h2')
