...
export const renderHeroSection = prefix => {
  ...
  while (e.firstElementChild) {
    let type1Selector =
      ...
      (prefix === 'single_page' && !document.body.classList.contains('blog'))
    ...
    if (prefix === 'single_blog_post') {
      if (
        document
          ...
          .parentNode.firstElementChild.classList.contains('share-box')
      ) {
  ...
  if (
    ...
    document
      ...
      .parentNode.removeChild(document.querySelector('.hero-section figure'))
  }
