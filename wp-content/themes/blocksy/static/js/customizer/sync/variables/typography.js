  ...
  [id]: [
    {
      ...
      whenDone: extractedValue =>
        loadGoogleFonts(extractedValue, wp.customize(id)().variation)
    },

    {
      ...
      whenDone: extractedValue =>
        loadGoogleFonts(wp.customize(id)().family, wp.customize(id)().variation)
    },
...

    {
      ...
      unit: '',
      responsive: true,
      extractValue: value => (value.desktop ? value : value.size)
    },

    {
      ...
      unit: '',
      responsive: true,
      extractValue: value => (value.desktop ? value : value['line-height'])
    },

    {
      ...
      unit: '',
      responsive: true,
      extractValue: value => (value.desktop ? value : value['letter-spacing'])
    }
  ]
})
