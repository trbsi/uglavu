  ...
  pluginEvent: function pluginEvent(eventName, sortable, evt) {
    ...
    plugins.forEach(function(plugin) {
      ...
      if (sortable[plugin.pluginName][eventNameGlobal]) {
        _this.eventCanceled = !!sortable[plugin.pluginName][eventNameGlobal](
          _objectSpread(
            {
              sortable: sortable
            },
...
var PositionGhostAbsolutely = IOS,
  ...
  supportDraggable =
    !ChromeForAndroid && !IOS && 'draggable' in document.createElement('div'),
  ...
  /** @lends Sortable.prototype */
  {
    ...
    _appendGhost: function _appendGhost() {
      ...
      if (!ghostEl) {
        ...
        css(ghostEl, 'transform', 'translateX(' + tapEvt.tapEvtOffset + ')')
        css(ghostEl, 'width', '100px')
  ...
  MultiDrag.prototype = {
    ...
    setupClone: function setupClone(_ref2) {
      ...
      for (var _i = 0; _i < multiDragElements.length; _i++) {
        ...
        multiDragElements[_i] === dragEl$1 &&
          toggleClass(multiDragClones[_i], sortable.options.chosenClass, false)
      }
