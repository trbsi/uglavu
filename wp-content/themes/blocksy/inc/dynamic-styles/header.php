...
// transparent state
$transparentHeaderBackground = blocksy_get_colors(
...
$headerShadow = blocksy_get_colors(
...
// site title & tagline
$siteTitleColor = blocksy_get_colors(
	get_theme_mod('siteTitleColor'),
	[
...
$css->put(
	'.site-title',
	"--linkInitialColor: {$siteTitleColor['default']}"
);

$css->put(
	'.site-title',
	"--linkHoverColor: {$siteTitleColor['hover']}"
);


$siteTaglineColor = blocksy_get_colors(
	get_theme_mod( 'siteTaglineColor'),
	['default' => ['color' => 'var(--paletteColor3)']]
);

$css->put(
	'.site-description',
	"--fontColor: {$siteTaglineColor['default']}"
);

// main menu
$menuFontColor = blocksy_get_colors(
	get_theme_mod('menuFontColor'),
	[
		'default' => [ 'color' => 'var(--paletteColor3)' ],
		'active' => [ 'color' => '#ffffff' ],
		'hover' => [ 'color' => 'var(--paletteColor1)' ],
...
$transparentHeaderFontColor = blocksy_get_colors(
	blocksy_akg_or_customizer(
...
$navSectionBackground = blocksy_get_colors(
	get_theme_mod('navSectionBackground'),
...
$dropdownFontColor = blocksy_get_colors(
	get_theme_mod('dropdownFontColor'),
	[
		'default' => [ 'color' => '#ffffff' ],
		'hover' => [ 'color' => 'var(--paletteColor1)' ],
	]
...
$dropDownBackground = blocksy_get_colors(
	get_theme_mod('dropDownBackground'),
...
// Top bar
$topBarFontColor = blocksy_get_colors(
	get_theme_mod('topBarFontColor'),
	[
...
$topBarBackground = blocksy_get_colors(
	get_theme_mod('topBarBackground'),
...
$mobileMenuIconColor = blocksy_get_colors(
	get_theme_mod('mobileMenuIconColor'),
	[
		'default' => [ 'color' => 'var(--paletteColor3)' ],
		'hover' => [ 'color' => 'var(--paletteColor1)' ],
	]
...
$mobileMenuLinkColor = blocksy_get_colors(
	get_theme_mod('mobileMenuLinkColor'),
	[
		'default' => [ 'color' => '#ffffff' ],
		'hover' => [ 'color' => 'var(--paletteColor1)' ],
	]
...
$mobileMenuBackground = blocksy_get_colors(
	get_theme_mod('mobileMenuBackground'),
...
// Header Search Modal
$searchHeaderIconColor = blocksy_get_colors(
	get_theme_mod('searchHeaderIconColor'),
	[
		'default' => [ 'color' => 'var(--paletteColor3)' ],
		'hover' => [ 'color' => 'var(--paletteColor1)' ],
	]
...
$searchHeaderBackground = blocksy_get_colors(
	get_theme_mod('searchHeaderBackground'),
	[ 'default' => [ 'color' => 'rgba(18, 21, 25, 0.98)' ] ]
);
...
$searchHeaderLinkColor = blocksy_get_colors(
	get_theme_mod('searchHeaderLinkColor'),
	[
...
// Header Cart
$cartHeaderIconColor = blocksy_get_colors(
	get_theme_mod('cartHeaderIconColor'),
	[
		'default' => [ 'color' => 'var(--paletteColor3)' ],
		'hover' => [ 'color' => 'var(--paletteColor1)' ],
	]
...
$cartBadgeColor = blocksy_get_colors(
	get_theme_mod('cartBadgeColor'),
	[
...
$cartFontColor = blocksy_get_colors(
	get_theme_mod('cartFontColor'),
	[
		'default' => [ 'color' => '#ffffff' ],
		'hover' => [ 'color' => 'var(--paletteColor1)' ],
	]
...
$cartDropDownBackground = blocksy_get_colors(
	get_theme_mod('cartDropDownBackground'),
	[ 'default' => [ 'color' => '#29333C' ] ]
);
...
// CTA button
$headerButtonFont = blocksy_get_colors(
	get_theme_mod('headerButtonFont'),
	[
		'default' => [ 'color' => '#ffffff' ],
		'hover' => [ 'color' => '#ffffff' ],
	]
...
$headerButtonBackground = blocksy_get_colors(
	get_theme_mod('headerButtonBackground'),
	[
