				...
				<a href="<?php echo esc_attr($link) ?>" target="_blank">
					<i>
						...
						<?php if ( $single_social['id'] === 'rss' ) { ?>
							<svg height="20" viewBox="0 0 23.3 20">
								<path class="st0" d="M16.6,0H3.4C1.5,0,0,1.5,0,3.4v13.2C0,18.5,1.5,20,3.4,20h13.2c1.9,0,3.4-1.5,3.4-3.4V3.4C20,1.5,18.5,0,16.6,0z M6,16.5c-1.2,0-2.1-0.9-2.1-2.1c0-1.2,0.9-2.1,2.1-2.1s2.1,0.9,2.1,2.1C8.1,15.6,7.2,16.5,6,16.5z M11.6,16.5c-0.6,0-1.2-0.5-1.2-1.2c0-3-2.4-5.3-5.3-5.3c-0.6,0-1.2-0.5-1.2-1.2c0-0.6,0.5-1.2,1.2-1.2c4.2,0,7.7,3.4,7.7,7.7C12.7,16,12.2,16.5,11.6,16.5z M15.8,16.5c-0.6,0-1.2-0.5-1.2-1.2c0-5.3-4.3-9.5-9.5-9.5c-0.6,0-1.2-0.5-1.2-1.2c0-0.6,0.5-1.2,1.2-1.2c3.4,0,6.3,1.2,8.5,3.4c2.3,2.3,3.4,5.1,3.4,8.4C16.9,16,16.4,16.5,15.8,16.5z"/>
							</svg>
						<?php } ?>
					</i>
				</a>
