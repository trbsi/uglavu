...
$options = [
	'header_top_bar_section_' . $number => [
		...
		'choices' => blocksy_ordered_keys(
			[
				'header_menu' => __( 'Header Menu', 'blocksy' ),
	...
	blocksy_rand_md5() => [
		'type' => 'ct-condition',
		'condition' => [ 'header_top_bar_section_' . $number => 'custom_text' ],
		'options' => [

			'header_top_bar_section_' . $number . '_text' => [
				'label' => false,
				'type' => 'textarea',
	...
	blocksy_rand_md5() => [
		'type' => 'ct-condition',
		'condition' => [ 'header_top_bar_section_' . $number => 'social_icons' ],
		'options' => [

			'header_top_bar_socials_' . $number => [
				'label' => false,
				'type' => 'ct-layers',
				'manageable' => true,
				'desc' => sprintf(
