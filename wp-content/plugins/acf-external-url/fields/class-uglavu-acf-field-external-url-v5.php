...
class uglavu_acf_field_external_url extends acf_field {
	...
	*/
	...
	function __construct( $settings ) {
		...
		*/
		...
		$this->label = __('External URL', 'acf-external-url');
		...
		*  var message = acf._e('external_url', 'error');
		*/
		
		$this->l10n = array(
			'error'	=> __('Error! Please enter a higher value', 'acf-external-url'),
		);
	...
	function render_field_settings( $field ) {
		...
		*/
		...
		acf_render_field_setting( $field, array(
			'label'			=> __('Font Size','acf-external-url'),
			'instructions'	=> __('Customise the input font size','acf-external-url'),
			'type'			=> 'number',
			'name'			=> 'font_size',
			'prepend'		=> 'px',
		));
	...
	*/
	...
	function render_field( $field ) {
		...
		*/
		...
		type="hidden" 
		name="og_title" 
		id="og_tags_title_input" />

		<input
		type="hidden" 
		name="og_image" 
		id="og_tags_image_input" />
		
		<input
		type="hidden" 
		name="og_url" 
		id="og_tags_url_input" />
	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		// register & include JS
		wp_register_script('acf-external-url', "{$url}assets/js/input.js", array('acf-input'), $version);
		wp_enqueue_script('acf-external-url');
		
		
		// register & include CSS
		wp_register_style('acf-external-url', "{$url}assets/css/input.css", array('acf-input'), $version);
		wp_enqueue_style('acf-external-url');
	...
	*/
	...
	function validate_value( $valid, $value, $field, $input ){
		...
		if( $value < $field['custom_minimum_setting'] )
		{
			$valid = __('The value is too little!','acf-external-url'),
		}
...
// initialize
new uglavu_acf_field_external_url( $this->settings );
