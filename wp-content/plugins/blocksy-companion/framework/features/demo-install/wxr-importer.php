...
class Blocksy_WP_Importer_Logger_ServerSentEvents extends WP_Importer_Logger {
    public function log( $level, $message, array $context = array() ) {
    }
}
...
class Blocksy_WXR_Importer extends \WP_Importer {
	/**
	...
	public function get_preliminary_information( $file ) {
		...
		// Start parsing!
		$data = new Blocksy_WXR_Import_Info();
